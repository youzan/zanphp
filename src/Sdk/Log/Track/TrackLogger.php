...
class TrackLogger extends Logger
{
    ...
    {
        return $this->appender->append($this->app, $this->module, "debug", $msg, $e, $extra);
    }

    public function info($msg, Exception $e = null, $extra = null)
    {

        return $this->appender->append($this->app, $this->module, "info", $msg, $e, $extra);
    }

    public function warn($msg, Exception $e = null, $extra = null)
    {
        return $this->appender->append($this->app, $this->module, "warn", $msg, $e, $extra);
    }

    public function error($msg, Exception $e = null, $extra = null)
    {
        return $this->appender->append($this->app, $this->module, "error", $msg, $e, $extra);
    }
