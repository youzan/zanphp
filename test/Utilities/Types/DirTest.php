...
class DirTest extends \UnitTest {
    ...
    public function testScanWorkFine()
    {
        ...
        $this->assertTrue(in_array($path . 'dir2/dir4/file10', $files), 'Dir::scan recusivly without dirs fail');
        ...
        $this->assertTrue(in_array($path . 'file2', $files), 'Dir::scan recusivly without dirs fail');
        $this->assertTrue(in_array($path . 'dir2/', $files), 'Dir::scan recusivly without dirs fail');
        $this->assertTrue(in_array($path . 'dir2/dir4/', $files), 'Dir::scan recusivly without dirs fail');
    }
